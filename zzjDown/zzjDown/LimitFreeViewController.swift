...
class LimitFreeViewController: UITableViewController,navigationBarProtocol,AddReFreshProtocol {
    ...
    func loadData() {
        let ahomepageUrlString = String(format: pricedropspecificUrlString, currentPage)
