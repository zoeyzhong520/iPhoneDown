...
class FreeViewController: UITableViewController,navigationBarProtocol,AddReFreshProtocol {
    ...
    func loadData() {
        let ahomepageUrlString = String(format: freespecificUrlString, currentPage)
