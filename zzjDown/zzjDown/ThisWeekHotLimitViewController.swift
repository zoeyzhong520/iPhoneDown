//
//  ThisWeekHotLimitViewController.swift
//  zzjDown
//
...
class ThisWeekHotLimitViewController: UITableViewController,AddReFreshProtocol {
    ...
    func loadData() {
        let ahomepageUrlString = String(format: thisweekhotlimitUrlString, currentPage)
