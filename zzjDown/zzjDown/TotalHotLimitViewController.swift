//
//  TotalHotLimitViewController.swift
//  zzjDown
//
...
class TotalHotLimitViewController: UITableViewController,AddReFreshProtocol {
    ...
    func loadData() {
        let ahomepageUrlString = String(format: totalhotlimitUrlString, currentPage)
